...
if __name__ == "__main__":
    ...
    optimizervgg16 = optim.Adam(vgg16.classifier.parameters(), lr=0.001)
    ########################################################################################################################
    ...
    class_to_idx = helper.load_checkpoint(filepath_=args.checkpoint_dir,
                                          model_name=vgg16,
                                          optimizer_name=optimizervgg16)
    ########################################################################################################################

    # Show the user the Predicted Flower as well as the Probability of that Prediction
    ########################################################################################################################
    dict = helper.final_output(args.prediction_image_path, model_vgg16, class_to_idx)
    print(dict)
    ########################################################################################################################